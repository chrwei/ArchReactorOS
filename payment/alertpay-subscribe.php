...
<input type="hidden" name="ap_itemname" value="<?= $name ?>"/>  
...
<input type="hidden" name="ap_timeunit" value="<?= $ap_timeunit ?>"/>  
<input type="hidden" name="ap_periodlength" value="<?= $ap_periodlength ?>"/> 
</form>